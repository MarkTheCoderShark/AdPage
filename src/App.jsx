      ...
      <section className="px-6 py-16 md:py-24 bg-stone-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "After years of dealing with late-night maintenance calls and difficult tenants, they've been a lifesaver. Everything is handled professionally and my rental stays consistently occupied.",
                name: "Sarah M.",
                location: "Roseville, CA",
                properties: "2 properties"
              },
              {
                quote: "I was hesitant to hire a property manager, but the peace of mind is worth every penny. They found great tenants and I actually see better returns than when I managed it myself.",
                name: "Michael C.",
                location: "Folsom, CA",
                properties: "1 property"
              },
              {
                quote: "The transparency is what sold me. I can log in anytime and see exactly where my money is going. No surprises, just professional management and consistent communication.",
                name: "Jennifer R.",
                location: "Rocklin, CA",
              ...
              <div key={i} className="bg-white rounded-2xl p-8 shadow-sm border border-stone-100">
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-stone-100">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">{testimonial.location} · {testimonial.properties}</p>
                  </div>
                </div>
              </div>
            ))}
